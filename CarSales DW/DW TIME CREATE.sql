...
DECLARE @EndDate DATETIME = '20050611' --End Value of Date Range

DECLARE @curDate DATE  --dont delete
DECLARE @FirstDayMonth DATE --depends if we need
DECLARE @QtrMonthNo int --depends if we need
DECLARE @FirstDayQtr DATE --depends if we need
